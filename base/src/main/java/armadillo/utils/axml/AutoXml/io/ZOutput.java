package armadillo.utils.axml.AutoXml.io;

import java.io.IOException;
import java.io.OutputStream;

public final class ZOutput implements AutoCloseable{
    ...
    public final int writeFully(byte[] b, int a, int len) throws IOException {
        dos.write(b, a, len);
        written += len;
        return len;
    }
