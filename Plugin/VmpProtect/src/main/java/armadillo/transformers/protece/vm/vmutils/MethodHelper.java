package armadillo.transformers.protece.vm.vmutils;
...
public class MethodHelper {
    ...
    @Nonnull
    public static String genMethodName(@Nonnull MethodReference reference) {
        if ("<init>".equals(reference.getName()))
            return "native_init";
        else if ("<clinit>".equals(reference.getName()))
            return "native_clinit";
