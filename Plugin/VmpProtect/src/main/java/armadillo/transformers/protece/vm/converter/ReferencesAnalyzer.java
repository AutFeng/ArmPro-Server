...
public class ReferencesAnalyzer {
    ...
    public ReferencesAnalyzer(List<String> keepMethodNames, ClassAnalyzer classAnalyzer) {
    ...
    public int getFieldItemIndex(FieldReference reference) {
        return fieldReferencesMapIndex.get(classAnalyzer.getDirectFieldRef(reference));
    }
        ...
        for (Instruction instruction : implementation.getInstructions()) {
            switch (instruction.getOpcode()) {
                ...
                case SPUT_OBJECT: {
                    ...
                    FieldReference fixReference = classAnalyzer.getDirectFieldRef(reference);
//                    if (reference.getName().equals("CHARSET"))
//                        System.out.println("src:"+reference.getDefiningClass()+" old:"+fixReference.getDefiningClass());
                    fieldReferences.add(fixReference);
                    break;
                }
                case CONST_STRING:
