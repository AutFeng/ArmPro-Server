...
public class SignerV1 extends OtherTransformer {
    @Override
    public void transform() throws Exception {
        ...
        byte[] bytes = LoaderRes.getInstance().getStaticResAsBytes("smali/SignerV1.smali");
        ...
        String body = new String(bytes)
                .replace("Larm/SignerV1;", String.format("Larm/%s;",randon))
