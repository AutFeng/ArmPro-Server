...
public class NetworkCheck extends OtherTransformer {
    @Override
    public void transform() throws Exception {
        ...
        byte[] bytes = LoaderRes.getInstance().getStaticResAsBytes("smali/Network.smali");
        String body = new String(bytes)
                .replace("Larm/Network;", String.format("Larm/%s;",randon));
