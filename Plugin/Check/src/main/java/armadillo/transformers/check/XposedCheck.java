...
public class XposedCheck extends OtherTransformer {
    @Override
    public void transform() throws Exception {
        ...
        byte[] bytes = LoaderRes.getInstance().getStaticResAsBytes("smali/XposedCheck.smali");
        String body = new String(bytes).replace("LArmadillo/XposedCheckProvider;",  String.format("Larm/%s;",randon));
