...
public class EmulatorCheck extends OtherTransformer {
    @Override
    public void transform() throws Exception {
        ...
        byte[] bytes = LoaderRes.getInstance().getStaticResAsBytes("smali/EmulatorCheck.smali");
        String body = new String(bytes)
                .replace("Larm/EnCheck;", String.format("Larm/%s;",randon));
